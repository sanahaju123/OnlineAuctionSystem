...
namespace Online_Auction.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        public async Task<bool> Testfor_Register_Product()
        {
            ...
            try
            {
                productservice.Setup(repos => repos.Register(_product));
        ...
        public async Task<bool> Testfor_Update_Product()
        {
            ...
            try
            {
                productservice.Setup(repos => repos.UpdateProduct(_updateProduct));
        ...
        public async Task<bool> Testfor_Register_Customer()
        {
            ...
            try
            {
                customerservice.Setup(repos => repos.Register(_customer));
        ...
        public async Task<bool> Testfor_Update_Customer()
        {
            ...
            try
            {
                customerservice.Setup(repos => repos.UpdateCustomer(_updateCustomer));
